...
- If the record exists, rename the app metadata to `Warranties Vault`, complete the required App Store Connect fields, wait a few minutes for propagation, then retry Xcode Organizer upload.
